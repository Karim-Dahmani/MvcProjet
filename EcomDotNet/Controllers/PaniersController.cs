...
namespace EcomDotNet.Controllers
{
    public class PaniersController : Controller
    {
        ...
        public PaniersController(EcomDotNetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Panier != null ? 
                          ...
                          Problem("Entity set 'EcomDotNetContext.Panier'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("PanierID,PanierDesc")] Panier panier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PanierID,PanierDesc")] Panier panier)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EcomDotNetContext.Panier'  is null.");
            }
            var panier = await _context.Panier.FindAsync(id);
            if (panier != null)
            {
